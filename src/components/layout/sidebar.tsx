        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div
            ...
            className={cn(
              ...
              draggingOver && "ring-2 ring-mint-300"
            )}
          >
            {loading ? (
              <>
              ...
              sidebarTickets.map((ticket) => (
                <div
                  ...
                  className="flex items-center gap-2 px-2 py-1.5 rounded transition-colors cursor-grab active:cursor-grabbing"
                >
                  <PortfolioDot portfolio={ticket.portfolio as Portfolio} />
                  <Link
                    href={`/requests/${ticket.id}`}
                    className="truncate text-white hover:text-mint-300 transition-colors flex-1 min-w-0"
